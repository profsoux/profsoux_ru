...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ScheduleFlow.event'
        db.add_column('conference_scheduleflow', 'event',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['conference.Event']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ScheduleFlow.event'
        db.delete_column('conference_scheduleflow', 'event_id')
