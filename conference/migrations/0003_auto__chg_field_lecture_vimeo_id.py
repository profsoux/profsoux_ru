...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Lecture.vimeo_id'
        db.alter_column('conference_lecture', 'vimeo_id', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

    def backwards(self, orm):

        # Changing field 'Lecture.vimeo_id'
        db.alter_column('conference_lecture', 'vimeo_id', self.gf('django.db.models.fields.TextField')(null=True))
