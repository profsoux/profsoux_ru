...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.coordinates'
        db.alter_column('conference_event', 'coordinates', self.gf('django.db.models.fields.CharField')(max_length=24, null=True))

        # Changing field 'Event.place'
        db.alter_column('conference_event', 'place', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

    def backwards(self, orm):

        # Changing field 'Event.coordinates'
        db.alter_column('conference_event', 'coordinates', self.gf('django.db.models.fields.CharField')(default='', max_length=24))

        # Changing field 'Event.place'
        db.alter_column('conference_event', 'place', self.gf('django.db.models.fields.CharField')(default='', max_length=64))
