...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Lecture.category'
        db.alter_column('conference_lecture', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['conference.Category'], null=True))

    def backwards(self, orm):

        # Changing field 'Lecture.category'
        db.alter_column('conference_lecture', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['conference.Category']))
