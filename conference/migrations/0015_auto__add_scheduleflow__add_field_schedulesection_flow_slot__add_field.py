...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ScheduleFlow'
        db.create_table('conference_scheduleflow', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('start_time', self.gf('django.db.models.fields.TimeField')()),
        ))
        db.send_create_signal('conference', ['ScheduleFlow'])

        # Adding field 'ScheduleSection.flow_slot'
        db.add_column('conference_schedulesection', 'flow_slot',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding M2M table for field flow on 'ScheduleSection'
        db.create_table('conference_schedulesection_flow', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('schedulesection', models.ForeignKey(orm['conference.schedulesection'], null=False)),
            ('scheduleflow', models.ForeignKey(orm['conference.scheduleflow'], null=False))
        ))
        db.create_unique('conference_schedulesection_flow', ['schedulesection_id', 'scheduleflow_id'])

        # Adding field 'Event.use_sections'
        db.add_column('conference_event', 'use_sections',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Event.use_flows'
        db.add_column('conference_event', 'use_flows',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ScheduleFlow'
        db.delete_table('conference_scheduleflow')

        # Deleting field 'ScheduleSection.flow_slot'
        db.delete_column('conference_schedulesection', 'flow_slot')

        # Removing M2M table for field flow on 'ScheduleSection'
        db.delete_table('conference_schedulesection_flow')

        # Deleting field 'Event.use_sections'
        db.delete_column('conference_event', 'use_sections')

        # Deleting field 'Event.use_flows'
        db.delete_column('conference_event', 'use_flows')
    ...
    models = {
        ...
        'conference.lecture': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'vimeo_id': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'})
        },
        ...
        'conference.scheduleflow': {
            'Meta': {'object_name': 'ScheduleFlow'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'conference.schedulesection': {
            ...
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['conference.Event']"}),
            'flow': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['conference.ScheduleFlow']", 'null': 'True', 'blank': 'True'}),
            'flow_slot': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
