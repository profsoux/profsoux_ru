...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.registration_start'
        db.add_column('conference_event', 'registration_start',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.registration_end'
        db.add_column('conference_event', 'registration_end',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.registration_start'
        db.delete_column('conference_event', 'registration_start')

        # Deleting field 'Event.registration_end'
        db.delete_column('conference_event', 'registration_end')
