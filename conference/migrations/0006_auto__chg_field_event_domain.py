...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.domain'
        db.alter_column('conference_event', 'domain', self.gf('django.db.models.fields.CharField')(max_length=64))

    def backwards(self, orm):

        # Changing field 'Event.domain'
        db.alter_column('conference_event', 'domain', self.gf('django.db.models.fields.URLField')(max_length=200))
