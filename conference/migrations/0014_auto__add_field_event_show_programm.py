...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.show_programm'
        db.add_column('conference_event', 'show_programm',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.show_programm'
        db.delete_column('conference_event', 'show_programm')
