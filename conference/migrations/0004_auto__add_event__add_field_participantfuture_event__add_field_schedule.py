...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('conference_event', (
            ...
            ('coordinates', self.gf('django.db.models.fields.CharField')(max_length=24)),
            ('place_note', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('conference', ['Event'])

        # Adding field 'ParticipantFuture.event'
        db.add_column('conference_participantfuture', 'event',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['conference.Event']),
                      keep_default=False)

        # Adding field 'ScheduleSection.event'
        db.add_column('conference_schedulesection', 'event',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['conference.Event']),
                      keep_default=False)

        # Adding field 'Participant.event'
        db.add_column('conference_participant', 'event',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['conference.Event']),
                      keep_default=False)

        # Adding field 'Partner.event'
        db.add_column('conference_partner', 'event',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['conference.Event']),
                      keep_default=False)

        # Adding field 'Lecture.event'
        db.add_column('conference_lecture', 'event',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['conference.Event']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ParticipantFuture.event'
        db.delete_column('conference_participantfuture', 'event_id')

        # Deleting field 'ScheduleSection.event'
        db.delete_column('conference_schedulesection', 'event_id')

        # Deleting field 'Participant.event'
        db.delete_column('conference_participant', 'event_id')

        # Deleting field 'Partner.event'
        db.delete_column('conference_partner', 'event_id')

        # Deleting field 'Lecture.event'
        db.delete_column('conference_lecture', 'event_id')
    ...
    models = {
        ...
        'conference.event': {
            ...
            'coordinates': ('django.db.models.fields.CharField', [], {'max_length': '24'}),
