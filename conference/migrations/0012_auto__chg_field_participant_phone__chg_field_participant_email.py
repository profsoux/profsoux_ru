...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Participant.phone'
        db.alter_column('conference_participant', 'phone', self.gf('django.db.models.fields.CharField')(max_length=24, null=True))

        # Changing field 'Participant.email'
        db.alter_column('conference_participant', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))

    def backwards(self, orm):

        # Changing field 'Participant.phone'
        db.alter_column('conference_participant', 'phone', self.gf('django.db.models.fields.CharField')(default='', max_length=24))

        # Changing field 'Participant.email'
        db.alter_column('conference_participant', 'email', self.gf('django.db.models.fields.EmailField')(default='none@none.test', max_length=75))
    ...
    models = {
        ...
        'conference.participant': {
            ...
            'email': ('django.db.models.fields.EmailField', [], {'default': "'none@none.test'", 'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['conference.Event']"}),
            'first_name': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_public': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'last_name': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'phone': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '24', 'null': 'True', 'blank': 'True'}),
